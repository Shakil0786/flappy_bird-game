...
pygame.display.set_caption('devloper -> shakil')  
...
# loading images  
background = pygame.image.load('d:/first4/imagess/background.png')  
base = pygame.image.load('d:/first4/imagess/base.png')  
button = pygame.image.load('d:/first4/imagess/restart.png')  
...
class FlappyBird(pygame.sprite.Sprite):  
    ...
    def __init__(self, x_coordinate, y_coordinate):  
        ...
        for i in range(1, 4):  
            ...
            image = pygame.image.load(f'd:/first4/imagess/bird_{i}.png')  
...
class Pipe(pygame.sprite.Sprite):  
    ...
    def __init__(self, x_coordinate, y_coordinate, position):  
        ...
        # using the load() function of the pygame.image module  
        self.image = pygame.image.load('d:/first4/imagess/pipe.png')  
